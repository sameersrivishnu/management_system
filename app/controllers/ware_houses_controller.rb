class WareHousesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ware_house.save
      products.each do |u|
          ProductWareHouse.create(product_id: u.id , ware_house_id: @ware_house.id, item_count: 0, low_item_threshold: 10)
      end      
  ...
  private
    ...
    def ware_house_params
      params.require(:ware_house).permit(:name, :wh_code, :pincode, :max_capacity)
    end
end
